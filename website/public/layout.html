...
<body class="layout-body primary-bg text-align-center document-font flex-container flex-content-center flex-wrap flex-items-center">
        ...
        <header id="header-container" class="flex-container flex-items-center flex-content-start flex-wrap border-radius-0-3 secondary-bg margin-top-1 margin-left-1 margin-right-1">
            ...
            <div id="nav-container" class="full-height flex-grow-2 flex-container flex-align-items-center flex-content-center">
                <ul id="link-container" class="margin-left-2 flex-container flex-align-items-center font-weight-bold font-size-0-938 border-radius-0-3">
                    <li class="link margin-left-0-35 margin-right-0-35"><button class="font-size-0-938 font-weight-bold padding-0-3 border-radius-0-3">Trending movies & shows</button></li>
                    <li class="link margin-left-0-35 margin-right-0-35"><button class="font-size-0-938 font-weight-bold padding-0-3 border-radius-0-3">Your favourites</button></li>
                    <li class="link margin-left-0-35 margin-right-0-35"><button class="font-size-0-938 font-weight-bold padding-0-3 border-radius-0-3">Feed</button></li>               
                </ul>
            </div>
    ...
    <footer class="footer flex-container flex-align-items-center flex-content-center">
        <div class="text-align-center font-size-0-938 font-weight-light primary-color">
